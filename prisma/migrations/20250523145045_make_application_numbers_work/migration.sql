...
CREATE TABLE "ApplicationNumberSequence" (
    ...
    CONSTRAINT "ApplicationNumberSequence_pkey" PRIMARY KEY ("id")
);

-- CreateIndex
CREATE UNIQUE INDEX "ApplicationNumberSequence_bank_id_key" ON "ApplicationNumberSequence"("bank_id");

-- CreateIndex
CREATE INDEX "ApplicationNumberSequence_bank_id_sequence_type_idx" ON "ApplicationNumberSequence"("bank_id", "sequence_type");

-- CreateIndex
CREATE UNIQUE INDEX "ApplicationNumberSequence_bank_id_sequence_type_key" ON "ApplicationNumberSequence"("bank_id", "sequence_type");

-- AddForeignKey
ALTER TABLE "ApplicationNumberSequence" ADD CONSTRAINT "ApplicationNumberSequence_bank_id_fkey" FOREIGN KEY ("bank_id") REFERENCES "Bank"("id") ON DELETE CASCADE ON UPDATE CASCADE;
