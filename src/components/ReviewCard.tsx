...
export const ReviewCard = ({ review }: ReviewCardProps): React.ReactNode => {
  ...
  const getStatusDisplay = () => {
    if (review.result) {
      return (
        <div className="flex items-start rounded-md bg-success-100 px-2 py-0.5">
          <span className="font-caption-bold text-caption-bold text-success-700">Approved</span>
        </div>
      );
    } else {
      return (
        <div className="flex items-start rounded-md bg-error-100 px-2 py-0.5">
  ...
  return (
    <div className="flex w-full flex-col items-start gap-3 py-1">
      <div className="flex w-full flex-col items-start gap-3 rounded-md border border-solid border-neutral-border bg-default-background px-3 py-2">
        ...
        <div className="flex w-full flex-wrap items-start gap-4 rounded-md border bg-gray-50 px-2 py-1.5">
        ...
        {review.remarks && (
          <div className="flex w-full flex-col items-start gap-1">
            ...
            <div className="flex w-full items-start rounded-md border border-neutral-200 bg-neutral-50 px-3 py-2">
