...
import { useCreateIncomeForm } from "../hooks/useCreateIncomeForm";
...
/**
 * Form component for creating a new income record
 */
export function CreateIncomeForm({ applicantId }: CreateIncomeFormProps) {
  ...
  const {
    ...
    onSubmit,
  } = useCreateIncomeForm(applicantId);
    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          <Button type="button" variant="outline" size="sm" onClick={removeYear} disabled={years.length <= 1}>
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col-reverse justify-end gap-4 sm:flex-row">
          ...
          <Button type="submit" className="gap-2" disabled={isSubmitting}>
            {isSubmitting ? t("processing") : t("saveAndContinue")}
