...
import { ViewGuarantorForm } from "@/app/[locale]/saas/(private)/guarantor/components/GuarantorForm/ViewGuarantorForm";

interface GuarantorViewPageProps {
  params: {
    id: string;
  };
}
 ...
 */
export default function GuarantorViewPage({ params }: GuarantorViewPageProps) {
  ...
  return (
    <div className="container mx-auto space-y-6 py-6">
      <PageHeader title={t("page.viewTitle")} description={t("page.viewDescription")} />

      <Suspense fallback={<Skeleton className="h-[500px] w-full" />}>
        <ViewGuarantorForm guarantor={guarantor} />
      </Suspense>
    </div>
  );
}
