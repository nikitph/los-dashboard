...
const PlotAndPropertyPurchaseAppraisal = () => {
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100/50 p-6">
      <div className="mx-left max-w-3xl space-y-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-medium">Plot Purchase and housing loan Appraisal</h1>
        </div>
...
export default PlotAndPropertyPurchaseAppraisal;
