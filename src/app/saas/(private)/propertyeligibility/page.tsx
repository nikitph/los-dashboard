...
const authorities = ["City Corporation", "Municipality", "Panchayat"];

const HouseConstructionAppraisal = () => {
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100/50 p-6">
      <div className="mx-left max-w-3xl space-y-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-medium">House Construction Loan Appraisal</h1>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <h2 className="text-base font-medium">Proposed property address</h2>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              <Label>Proposed built up area</Label>
              <Input type="number" placeholder="Enter built up area" className="bg-white" />
            </div>
          ...
          {/* Estimate and Architect */}
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label>Estimate for construction</Label>
              <div className="flex gap-2">
                <Input placeholder="Choose file" className="bg-white" readOnly />
                <Button className="bg-[#2A3558] hover:bg-[#2A3558]/90">Upload</Button>
              </div>
            ...
            <div className="space-y-2">
              <Label>Name of architect</Label>
              <Input placeholder="Enter architect name" className="bg-white" />
            </div>
          </div>
            ...
            <div className="space-y-2">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline" className="w-full justify-start bg-white text-left font-normal">
                    <CalendarIcon className="mr-2 h-4 w-4" />
                    {sanctionDate ? format(sanctionDate, "PP") : "Pick a date"}
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-0" align="start">
              ...
              <Select>
                ...
                <SelectContent>
                  {authorities.map((authority) => (
                    <SelectItem key={authority} value={authority.toLowerCase()}>
                      {authority}
                    </SelectItem>
                  ))}
                </SelectContent>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-8">
                ...
                <span className="text-base">As per estimate and plot valuation</span>
              </div>
...
export default HouseConstructionAppraisal;
